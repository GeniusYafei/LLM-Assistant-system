...
export function MessageList({
  ...
  const getLatencyLabel = (metadata) => {
    ...
    const latencyValue =
      metadata.latency_ms ?? metadata.latency ?? metadata.latencyMs;
  ...
  const getTokenLabel = (metadata) => {
    ...
    const outputTokens =
      usage.output_tokens ?? usage.generated_tokens ?? usage.completion_tokens;
        ...
        <div className="text-center space-y-4 max-w-md">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Start a conversation by typing a message below. You can upload
              documents to provide context for more accurate responses.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <ScrollArea
      ref={scrollAreaRef}
      className="h-full px-3 md:px-6 py-2 md:py-3"
    >
          ...
          <div key={message.id} className="group">
            {message.role === "user" ? (
              ...
              <div className="flex items-start gap-2 md:gap-4 justify-end w-full">
                <div className="flex flex-col items-end flex-1 min-w-0 max-w-[85%] sm:max-w-[80%] md:max-w-[70%]">
                  ...
                  {message.attachedDocuments &&
                    message.attachedDocuments.length > 0 && (
                      <div className="mb-3 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 w-full">
                        <p className="text-xs font-medium text-blue-900 dark:text-blue-300 mb-1">
                          Context documents:
                        </p>
                        <div className="flex flex-wrap gap-1">
                          {getAttachedDocumentNames(
                            message.attachedDocuments
                          ).map((name, index) => (
                            <Badge
                              key={index}
                  ...
                  {/* User Message Bubble */}
                  <div className="bg-gray-900 dark:bg-blue-600 text-white rounded-2xl rounded-tr-md px-3 md:px-4 py-2 md:py-3 shadow-sm max-w-full overflow-hidden break-words w-full">
                    <div
                ...
                <div className="flex-shrink-0">
                  <div className="w-7 h-7 md:w-8 md:h-8 rounded-full flex items-center justify-center bg-gray-900 dark:bg-blue-600 text-white">
              ...
              <div className="flex items-start gap-2 md:gap-4 w-full max-w-full overflow-hidden break-words">
                {/* AI Avatar */}
                <div className="flex-shrink-0">
                  <div className="w-7 h-7 md:w-8 md:h-8 rounded-full flex items-center justify-center bg-blue-600 dark:bg-blue-500 text-white">
                ...
                <div className="flex-1 min-w-0 max-w-[90%] sm:max-w-[80%] md:max-w-[70%]">
                  ...
                  {message.reasoning && (
                    <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl p-2 mb-2">
                  ...
                  <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl rounded-tl-md px-3 md:px-4 py-2 md:py-3 shadow-sm">
                  ...
                  {message.status === "error" && (
                    <div className="flex items-center space-x-2 mt-2 text-xs text-red-600 dark:text-red-400">
                      <AlertCircle className="h-3 w-3" />
